...
const GetArts = async (arts) => {
  ...
  DEBUG &&
    console.debug(
      "\t[失落回路Admonition渲染][Views/Item/Quartz/Regular/Admonition/view.js][GetArts()]:\n\t",
      arts
    );
  return Promise.all(
    arts.map((art) =>
...
DEBUG &&
  console.debug(
    "[失落回路Admonition渲染][Views/Item/Quartz/Regular/Admonition/view.js][Input]:\n",
    { quartz, options }
  );
