...
DEBUG && console.debug("[带数量结晶回路InLine渲染][Views/Item/Quartz/Regular/Count/view.js][Input]:\n", { link, options });
const inline = dv.view("Item/Quartz/Regular/Inline", { link, options }).then(inline => {
    if(inline === '') {
        return '';
    }
